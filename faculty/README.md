...
This guide is the starting point for **IT 140 faculty** who need to teach, support students, interpret course activities, and route technical or learning-support problems.

This repository is written for faculty and staff. Students may be able to view it because it is public, but student-facing directions should remain in D2L Brightspace, student-facing course repositories/wikis, and official support systems.
...
7. Review [Academic Support for IT 140](../academic-support/README.md) so you can distinguish programming-learning support from coaching and other Academic Support services.
...
| [Supporting Students](supporting-students.md) | Distinguishing technical, learning, academic-skills/coaching, assignment, and repository problems |
...
| Help understanding Python, pseudocode, flowcharts, testing, or debugging | Faculty may help; [Academic Support](../academic-support/README.md) is also appropriate |
| Needs time/task prioritization, organization, technical-reading strategies, or learning strategies | [Academic Coaching](../academic-support/coaching.md) |
| Needs on-demand general Python help | [24/7 Drop-In Tutoring](../academic-support/tutoring.md) may be appropriate |
...
| Python runs, but the student's own code is wrong | Faculty/Academic Support learning path, not Service Desk |
...
| Academic Support service selection | [Academic Support for IT 140](../academic-support/README.md) |
