...
### During the Instruction Portion
...
Questions may move across different layers.

Use this quick classification:

| Question | Response |
| --- | --- |
| "Why does this loop never stop?" | Help trace the student's condition and variable changes |
| "How do dictionaries work?" | Explain the concept and practice with a separate example |
| "What does this rubric criterion mean?" | Refer to faculty/current Guidelines and Rubric |
...
> **What are you trying to do? → What did you expect? → What happened instead? → Is this concept/code, assignment interpretation, or environment?**
...
Recurring patterns are useful signals.
