...
This repository is written for faculty and staff. Students may be able to view it because it is public, but student-facing Academic Support directions should remain in official student-facing systems and course resources.
...
LSS are one part of a broader Academic Support system. For the canonical F&S-facing overview of tutoring, coaching, written feedback, ELL/ESOL support, and LSS services, use [Academic Support for IT 140](../academic-support/README.md).
...
| [Referrals and Escalation](referrals-and-escalation.md) | Route faculty, tutoring/coaching, technical, advising, and course-resource issues |
...
| Needs quick on-demand Python help outside an LSS session | [24/7 Drop-In Tutoring](../academic-support/tutoring.md) may be appropriate |
| Needs time/task prioritization, organization, technical-reading strategies, academic-skill development, or learning-difference strategies | [Academic Coaching](../academic-support/coaching.md) may be appropriate |
| Needs writing-development feedback on an IT 140 written deliverable | See [Academic Support for IT 140](../academic-support/README.md#written-feedback) |
...
See [Academic Support Boundary](../shared/support-boundaries.md#academic-support-boundary) and
...
| Which Academic Support service best fits the need? | [Academic Support for IT 140](../academic-support/README.md) |
