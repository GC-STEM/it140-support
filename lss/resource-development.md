# IT 140 LSS | Academic Resource Center Development

LSS create reusable learning resources for the
[SNHU Academic Resource Center](https://snhuacademicresourcecenter.screenstepslive.com/m/138398).

For IT 140, resource development should complement the course rather than create a second, competing version of course instructions.

## Start by Checking Existing Resources

Before creating a new resource:

1. search the Academic Resource Center;
2. review the current General Programming and Python content;
3. identify whether an existing resource can be reused or updated;
4. review current IT 140 course terminology and examples; and
5. confirm that the resource fills a durable learning need rather than a one-time course defect.

<!-- screenshot placeholder; show the Academic Resource Center Computer Science & Data Analytics page with the search field plus General Programming and Python sections visible -->

## Good Candidates for Reusable Resources
...
## Avoid Duplicating Course-Managed Technical Instructions
...
A learning resource may link to those canonical sources when technical context is necessary.

## Verify Tool-Specific Applicability

The Academic Resource Center contains programming materials that may span different courses and development tools.
...
IT 140 is an introductory course.
...
Reusable resources should teach **skills and reasoning**, not publish completed solutions to graded IT 140 assignments or projects.
...
## When a Resource Problem Is Found During Student Support
